 ...
 * enables the JFrame to get user inputs to create
 * a portfolio via Dollar Cost Average with equal weights.
 **/
public class DCASubPanelEqualWeights extends JFrame implements TextFieldView {

  private final JButton homeEqualWeight;
  private final JButton exit;
  private final JButton createPortEqualWeight;
  ...
  /**
   * This is a constructor for DCASubPanelEqualWeights class,
   * it initializes the JFrame to get the user input.
   **/

  public DCASubPanelEqualWeights(int numOfStocks) {
    super();
    ...
    createPortEqualWeight = new JButton("Create Portfolio");
    createPortEqualWeight.setActionCommand("createPortEqualWeight");
    homeEqualWeight = new JButton("Go to Main Menu");
    homeEqualWeight.setActionCommand("homeEqualWeight");
    exit = new JButton("exit");
    exit.setActionCommand("exit");
    JPanel buttonPanel = new JPanel();
    buttonPanel.add(createPortEqualWeight);
    buttonPanel.add(homeEqualWeight);
  ...
  public void addActionListener(ActionListener listener) {
    createPortEqualWeight.addActionListener(listener);
    homeEqualWeight.addActionListener(listener);
  ...
  public void hideMainButton() {
    createPortEqualWeight.setEnabled(false);
  }
