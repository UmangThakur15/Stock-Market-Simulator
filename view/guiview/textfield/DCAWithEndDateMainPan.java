 ...
 * add Dollar cost strategy with end date.
 */
public class DCAWithEndDateMainPan extends JFrame implements TextFieldView {

  private final JTextField portfolioIdI;

  private final JTextField amountI;
  private final JTextField intervalI;
  private final JButton addDollarCostW;
  private final JButton homeCreateDCAWithEnd;
  ...
  private JTextField endDateI;
  private Color customColor;


  /**
   * This is a constructor for DCAWithEndDateMainPan class,
   * it initializes the JFrame to get the user input.
   **/
  public DCAWithEndDateMainPan() {
    super();
    final JLabel amount;
    ...
    dollarCostAverageWithEndDate.setBorder(BorderFactory.createTitledBorder("Add "
    ...
    addDollarCostW = new JButton("Add Stocks to the Portfolio via Dollar Cost Avg");
    homeCreateDCAWithEnd = new JButton("Go to Main Menu");
    exit = new JButton("Exit");

    addDollarCostW.setActionCommand("addDollarCostW");
    homeCreateDCAWithEnd.setActionCommand("homeCreateDCAWithEnd");
    exit.setActionCommand("exit");

    buttonPanel.add(addDollarCostW);
    buttonPanel.add(homeCreateDCAWithEnd);
    ...
    String[] monthNumber1 = {"01", "02", "03", "04", "05", "06", "07", "08", "09",
        "10", "11", "12"};
    ...
    String[] monthNumber2 = {"01", "02", "03", "04", "05", "06", "07", "08", "09",
        "10", "11", "12"};
  ...
  public void addActionListener(ActionListener listener) {
    addDollarCostW.addActionListener(listener);
    homeCreateDCAWithEnd.addActionListener(listener);
