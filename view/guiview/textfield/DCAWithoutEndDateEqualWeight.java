 ...
 * add dollar cost Strategy with equal weights.
 */
public class DCAWithoutEndDateEqualWeight extends JFrame implements TextFieldView {
  ...
  private final JButton addDCAEqualWo;
  private final JButton homeEqualWithout;
  ...
  /**
   * This is a constructor for DCAWithoutEndDateEqualWeight class,
   * it initializes the JFrame to get the user input.
   **/
  public DCAWithoutEndDateEqualWeight() {
    super();
    ...
    addDCAEqualWo = new JButton("Add Stocks to the Portfolio via Dollar Cost Average");
    homeEqualWithout = new JButton("Go to Main Menu");
    exit = new JButton("Exit");

    addDCAEqualWo.setActionCommand("addDCAEqualWo");
    homeEqualWithout.setActionCommand("homeEqualWithout");
    exit.setActionCommand("exit");


    buttonPanel.add(addDCAEqualWo);
    buttonPanel.add(homeEqualWithout);
  ...
  public void addActionListener(ActionListener listener) {
    addDCAEqualWo.addActionListener(listener);
    homeEqualWithout.addActionListener(listener);
